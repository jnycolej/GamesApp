  ...
  return (
    <div className="min-h-screen w-screen" style={backgroundStyle}>
      ...
      <div className="px-4 py-6">
        <p className="text-5xl text-center !tracking-wider font-semibold text-stone-50 text-shadow-stone-800 !text-shadow-lg">
          {game?.toUpperCase()}
        </p>
        <p className="text-7xl text-center text-shadow-stone-800 !text-shadow-lg text-stone-50">Choose Game Mode</p>
        <div className="p-5 max-w-4xl mx-auto">
          <div className="flex flex-row sm:flex-row justify-center gap-3 sm:gap-4">
            <div>
              <Button
                className="rounded-full !bg-yellow-400 !rounded-full !text-2xl text-stone-900 p-2 p-2 font-semibold text-base sm:px-5 sm:py-4.5 sm:text-lg md:px-6 md:py-5 md:text-xl"
                onClick={goSingle}
              >
                Single Player
              </Button>
            ...
            <div>
              <Button
                className="rounded-full !bg-emerald-600 !rounded-full !text-2xl font-semibold px-4 py-2 text-base sm:px-5 sm:py-2.5 sm:text-lg md:px-6 md:py-3 md:text-xl"
                onClick={goMulti}
              >
                Multiplayer
              </Button>
